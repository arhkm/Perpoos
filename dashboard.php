...
<body>
	...
	<div class="container md-margin-top">
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="panel alert alert-dissmissble" role="alert">
					<div class="panel-heading">
						...
						<div class="row text-center">
							<div class="col-xs-2 col-xs-offset-3"><a href="">Progress</a></div>
							<div class="col-xs-2"><a href="">Draft</a></div>
							<div class="col-xs-2"><a href="">Completed</a></div>
						</div>
					</div>
						...
						<div class="panel-body">
							...
							<div class="row" style="margin: 20px 0;">
								...
								<div class="col-sm-8 col-xs-6">
									...
									<p>Written By : Name</p>
									<div class="box-likes">
										<p class="fa-icons"><i class="fa fa-heart fa-red"></i> 1000</p>
										<p class="fa-icons"><i class="fa fa-eye fa-red"></i> 200</p>
										<p class="fa-icons"><i class="fa fa-file fa-red"></i> 100</p>
										<div class="clear"></div>
									</div>
									<p>About :</p>
					...
					<div class="panel-body">
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-xs-3">
									<button class="new-btn btn-block btn-follow">Unfollow</button>
								</div>
							</div>
							<div class="divider"></div>
							<?php } ?>
